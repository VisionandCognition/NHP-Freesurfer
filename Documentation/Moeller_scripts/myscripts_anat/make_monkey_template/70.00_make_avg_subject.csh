...
set hemi_list = (lh rh)
set out_subject = monkey_average
set surf = sphere

make_average_subject --no-vol --force --out avgerage_monkey --subjects ${monkey_list[*]}
...
foreach monkey ($monkey_list)
	...
	mris_register -curv ${hemi}.sphere $SUBJECTS_DIR/avg_monkey/${hemi}.monkey_average.tif ${hemi}.sphere.reg
    end
    cd $base_dir
end
...
foreach monkey ($monkey_list)
    ...
    foreach hemi ($hemi_list)
	echo processing: $hemi
	mris_register -curv ${hemi}.sphere $SUBJECTS_DIR/avg_monkey/${hemi}.monkey_average_2.tif ${hemi}.sphere.reg1
    end
    cd $base_dir
end
